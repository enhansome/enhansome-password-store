...
* **[Pass for iOS](https://github.com/mssun/passforios) ⭐ 1,644 | 🐛 174 | 🌐 Swift | 📅 2026-08-16**: An iOS client.
* **[passforios](https://github.com/mssun/passforios) ⭐ 1,644 | 🐛 174 | 🌐 Swift | 📅 2026-08-16**: Pass for iOS - an iOS client compatible with Pass command line application.
...
* **[prs](https://github.com/timvisee/prs) ⭐ 262 | 🐛 13 | 🌐 Rust | 📅 2026-05-08**: A multi-platform pass client in Rust supporting sync, TOTP, Tombs and more.
...
* **[rofi-pass-wayland](https://github.com/Seme4eg/rofi-pass-wayland) ⭐ 19 | 🐛 2 | 🌐 Shell | 📅 2026-01-12**: Rofi frontent for ZX2C4 pass project (wayland only).
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 2 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-18**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
