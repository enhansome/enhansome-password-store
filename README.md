...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 446 | 🐛 30 | 🌐 Kotlin | 📅 2026-09-17**: Android application compatible with ZX2C4's Pass command line application.
...
* **[NativePass](https://github.com/li-nd/NativePass) ⭐ 6 | 🐛 2 | 🌐 Swift | 📅 2026-09-17**: Native SwiftUI GUI for the Unix password manager pass on macOS.
...
* **[instantpass](https://github.com/instantos/instantpass) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2025-05-26**: an [instantmenu](https://github.com/instantOS/instantMENU) ⭐ 20 | 🐛 6 | 🌐 Rust | 📅 2026-09-17 frontend with support for pass-opt and pass-file.
