...
* **[pass-otp](https://github.com/tadfisher/pass-otp) ⭐ 1,489 | 🐛 73 | 🌐 Shell | 📅 2025-08-09**: support for one-time-password (OTP) tokens.
...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 438 | 🐛 28 | 🌐 Kotlin | 📅 2026-08-31**: Android application compatible with ZX2C4's Pass command line application.
...
* **[instantpass](https://github.com/instantos/instantpass) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2025-05-26**: an [instantmenu](https://github.com/instantOS/instantMENU) ⭐ 20 | 🐛 5 | 🌐 Rust | 📅 2026-08-31 frontend with support for pass-opt and pass-file.
