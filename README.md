...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 449 | 🐛 33 | 🌐 Kotlin | 📅 2026-09-21**: Android application compatible with ZX2C4's Pass command line application.
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 9 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-16**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
* **[pext\_module\_pass](https://github.com/Pext/pext_module_pass) ⚠️ Archived**: Password management module for Pext.
* **[NativePass](https://github.com/li-nd/NativePass) ⭐ 7 | 🐛 2 | 🌐 Swift | 📅 2026-09-21**: Native SwiftUI GUI for the Unix password manager pass on macOS.
