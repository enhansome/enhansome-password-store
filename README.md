...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 445 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-15**: Android application compatible with ZX2C4's Pass command line application.
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 9 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-15**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
