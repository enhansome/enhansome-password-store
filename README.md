...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 440 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-02**: Android application compatible with ZX2C4's Pass command line application.
* **[pass-winmenu](https://github.com/geluk/pass-winmenu) ⭐ 422 | 🐛 14 | 🌐 C# | 📅 2026-08-18**: An easy-to-use Windows interface for pass
* **[pass-git-helper](https://github.com/languitar/pass-git-helper) ⭐ 373 | 🐛 2 | 🌐 Python | 📅 2026-09-02**: A git credential helper interfacing with pass.
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 7 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-02**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
...
* **[instantpass](https://github.com/instantos/instantpass) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2025-05-26**: an [instantmenu](https://github.com/instantOS/instantMENU) ⭐ 20 | 🐛 5 | 🌐 Rust | 📅 2026-09-02 frontend with support for pass-opt and pass-file.
