...
* **[Pass for iOS](https://github.com/mssun/passforios) ⭐ 1,644 | 🐛 174 | 🌐 Swift | 📅 2026-08-09**: An iOS client.
* **[passforios](https://github.com/mssun/passforios) ⭐ 1,644 | 🐛 174 | 🌐 Swift | 📅 2026-08-09**: Pass for iOS - an iOS client compatible with Pass command line application.
...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 429 | 🐛 27 | 🌐 Kotlin | 📅 2026-08-13**: Android application compatible with ZX2C4's Pass command line application.
* **[pass-winmenu](https://github.com/geluk/pass-winmenu) ⭐ 420 | 🐛 14 | 🌐 C# | 📅 2024-04-18**: An easy-to-use Windows interface for pass
* **[pass-git-helper](https://github.com/languitar/pass-git-helper) ⭐ 372 | 🐛 1 | 🌐 Python | 📅 2026-08-12**: A git credential helper interfacing with pass.
...
* **[pass\_rlded](https://github.com/bergercookie/awesome-albert-plugins/tree/master/plugins/pass_rlded) ⚠️ Archived**: [Albert](https://github.com/albertlauncher/albert) ⭐ 7,969 | 🐛 6 | 🌐 C++ | 📅 2026-08-11 integration
...
* **[Identities](https://github.com/k8ieone/identities) ⭐ 14 | 🐛 23 | 🌐 Python | 📅 2026-07-15**: Modern password-store client made for GNOME.
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 2 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-13**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
