...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 451 | 🐛 32 | 🌐 Kotlin | 📅 2026-09-24**: Android application compatible with ZX2C4's Pass command line application.
...
* **[pass-secret-service](https://github.com/grimsteel/pass-secret-service) ⭐ 80 | 🐛 6 | 🌐 Rust | 📅 2026-07-03**: Implementation of org.freedesktop.secrets (D-Bus Secret Service) using pass.
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 9 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-24**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
