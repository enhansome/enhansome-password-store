...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 445 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-16**: Android application compatible with ZX2C4's Pass command line application.
...
* **[pass\_rlded](https://github.com/bergercookie/awesome-albert-plugins/tree/master/plugins/pass_rlded) ⚠️ Archived**: [Albert](https://github.com/albertlauncher/albert) ⭐ 7,996 | 🐛 6 | 🌐 C++ | 📅 2026-09-13 integration
...
* **[pass-secret-service](https://github.com/grimsteel/pass-secret-service) ⭐ 79 | 🐛 6 | 🌐 Rust | 📅 2026-07-03**: Implementation of org.freedesktop.secrets (D-Bus Secret Service) using pass.
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 9 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-16**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
...
* **[instantpass](https://github.com/instantos/instantpass) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2025-05-26**: an [instantmenu](https://github.com/instantOS/instantMENU) ⭐ 20 | 🐛 5 | 🌐 Rust | 📅 2026-09-16 frontend with support for pass-opt and pass-file.
