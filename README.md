...
* **[Pass for iOS](https://github.com/mssun/passforios) ⭐ 1,644 | 🐛 174 | 🌐 Swift | 📅 2026-08-14**: An iOS client.
* **[passforios](https://github.com/mssun/passforios) ⭐ 1,644 | 🐛 174 | 🌐 Swift | 📅 2026-08-14**: Pass for iOS - an iOS client compatible with Pass command line application.
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 2 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-14**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
