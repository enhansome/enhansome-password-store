...
* **[pass-extension-tail](https://github.com/palortoff/pass-extension-tail) ⭐ 89 | 🐛 1 | 🌐 Shell | 📅 2022-04-28**: A pass extension to avoid printing the password to the console.
...
* **[pass-import](https://github.com/roddhjav/pass-import) ⭐ 916 | 🐛 22 | 🌐 Python | 📅 2026-06-07**: a generic importer tool from other password managers.
...
* **[pass-otp](https://github.com/tadfisher/pass-otp) ⭐ 1,496 | 🐛 73 | 🌐 Shell | 📅 2025-08-09**: support for one-time-password (OTP) tokens.
...
* **[Pass for iOS](https://github.com/mssun/passforios) ⭐ 1,644 | 🐛 174 | 🌐 Swift | 📅 2026-08-19**: An iOS client.
* **[passforios](https://github.com/mssun/passforios) ⭐ 1,644 | 🐛 174 | 🌐 Swift | 📅 2026-08-19**: Pass for iOS - an iOS client compatible with Pass command line application.
* **[passff](https://github.com/passff/passff) ⭐ 1,292 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-26**: zx2c4 pass manager extension for Firefox, Chrome and Opera.
* **[browserpass](https://github.com/browserpass/browserpass-extension) ⭐ 1,016 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-03**: Chrome & Firefox browser extension for pass.
* **[ripasso](https://github.com/cortex/ripasso) ⭐ 831 | 🐛 33 | 🌐 Rust | 📅 2026-07-27**: A simple password manager written in Rust.
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 443 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-12**: Android application compatible with ZX2C4's Pass command line application.
* **[pass-winmenu](https://github.com/geluk/pass-winmenu) ⭐ 422 | 🐛 14 | 🌐 C# | 📅 2026-08-18**: An easy-to-use Windows interface for pass
* **[pass-git-helper](https://github.com/languitar/pass-git-helper) ⭐ 372 | 🐛 2 | 🌐 Python | 📅 2026-09-10**: A git credential helper interfacing with pass.
* **[prs](https://github.com/timvisee/prs) ⭐ 263 | 🐛 14 | 🌐 Rust | 📅 2026-09-08**: A multi-platform pass client in Rust supporting sync, TOTP, Tombs and more.
...
* **[pass\_rlded](https://github.com/bergercookie/awesome-albert-plugins/tree/master/plugins/pass_rlded) ⚠️ Archived**: [Albert](https://github.com/albertlauncher/albert) ⭐ 7,993 | 🐛 6 | 🌐 C++ | 📅 2026-08-23 integration
...
* **[pass-secret-service](https://github.com/grimsteel/pass-secret-service) ⭐ 78 | 🐛 6 | 🌐 Rust | 📅 2026-07-03**: Implementation of org.freedesktop.secrets (D-Bus Secret Service) using pass.
...
* **[Identities](https://github.com/k8ieone/identities) ⭐ 17 | 🐛 23 | 🌐 Python | 📅 2026-07-15**: Modern password-store client made for GNOME.
...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 8 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-12**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
* **[NativePass](https://github.com/li-nd/NativePass) ⭐ 5 | 🐛 1 | 🌐 Swift | 📅 2026-08-31**: Native SwiftUI GUI for the Unix password manager pass on macOS.
...
* **[instantpass](https://github.com/instantos/instantpass) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2025-05-26**: an [instantmenu](https://github.com/instantOS/instantMENU) ⭐ 20 | 🐛 5 | 🌐 Rust | 📅 2026-09-08 frontend with support for pass-opt and pass-file.
...
* **[firefox\_decrypt](https://github.com/Unode/firefox_decrypt) ⭐ 2,481 | 🐛 1 | 🌐 Python | 📅 2026-08-25**: Full blown Firefox password interface which supports exporting to pass
