...
* **[parcel](https://github.com/parcel-pm/parcel) ⭐ 9 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-25**: [Chrome](https://chromewebstore.google.com/detail/parcel/ciifpadakeohfnnneflckhojbldkkllp) & [Firefox](https://addons.mozilla.org/en-GB/firefox/addon/parcel-pm/) browser extension with no external dependencies.
