...
* **[Android-Password-Store](https://github.com/agrahn/Android-Password-Store) ⭐ 442 | 🐛 31 | 🌐 Kotlin | 📅 2026-09-09**: Android application compatible with ZX2C4's Pass command line application.
* **[pass-winmenu](https://github.com/geluk/pass-winmenu) ⭐ 422 | 🐛 14 | 🌐 C# | 📅 2026-08-18**: An easy-to-use Windows interface for pass
* **[pass-git-helper](https://github.com/languitar/pass-git-helper) ⭐ 372 | 🐛 1 | 🌐 Python | 📅 2026-09-07**: A git credential helper interfacing with pass.
...
* **[pass\_rlded](https://github.com/bergercookie/awesome-albert-plugins/tree/master/plugins/pass_rlded) ⚠️ Archived**: [Albert](https://github.com/albertlauncher/albert) ⭐ 7,990 | 🐛 7 | 🌐 C++ | 📅 2026-08-23 integration
